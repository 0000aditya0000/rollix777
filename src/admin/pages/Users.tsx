...
const Users = () => {
  ...
  const deleteUser = async (id) => {
    try {
      await axios.delete(`http://191.101.81.104:5000/api/user/user/${id}`);
  ...
  const addNewUser = async (userData) => {
    try {
      const response = await axios.post('http://191.101.81.104:5000/api/admin/user', userData);
  ...
  const updateUser = async (id, userData) => {
    try {
      const response = await axios.put(`http://191.101.81.104:5000/api/user/user/${id}`, userData);
      setUsers((prevUsers) =>
