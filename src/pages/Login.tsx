...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#ECEBDE] font-poppins overflow-y-auto">
      {/* Mobile Container */}
      <div className="w-full max-w-md mx-auto min-h-screen bg-[#000] shadow-[0_0_35px_rgba(219,105,3,0.3)] overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#db6903] via-[#e1910a] to-[#bc9713] p-6 text-white">
          ...
          <p className="text-sm mt-2 opacity-90 leading-snug">
            ...
            <br />
            If you forget your password, contact customer service.
          </p>
        </div>
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Remember */}
          <label className="flex items-center text-[#bc9713] cursor-pointer text-sm">
            <input
              type="checkbox"
              checked={remember}
              onChange={(e) => setRemember(e.target.checked)}
              className="mr-2 accent-[#db6903]"
            />
            Remember password
          </label>

          {/* Login */}
          {/* shadow-[0_0_25px_rgba(241,169,3,0.5)] */}
          <button className="w-full py-3 rounded-lg bg-gradient-to-r from-[#db6903] via-[#e1910a] to-[#bc9713] text-black font-semibold text-lg tracking-wide hover:scale-[1.02] transform transition">
            Log In
          </button>
          ...
          {/* bg-[#220904] */}
          <button
            className="w-full py-3 rounded-lg border border-[#db6903] text-[#db6903] font-medium text-lg tracking-wide hover:bg-[#3d1601] transition"
