          ...
          <div className="flex justify-between items-center mb-4">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-[#2A2A3E] border border-[#3D3D5C] px-3 py-1 rounded-full text-purple-400 hover:bg-[#3A3A4E] transition text-sm"
              >
                How to play
              </button>
            </div>
      ...
      {showHowToPlay && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
          <div className="bg-[#1F1F30] w-full max-w-3xl rounded-xl p-4 sm:p-6 shadow-lg border border-[#2D2D45] overflow-y-auto max-h-[90vh]">
            ...
            {/* Content */}
            <div className="text-gray-300 text-xs sm:text-sm space-y-4">
              <div>
                <h3 className="font-semibold text-purple-300">
                  What is a Hash Value?
                </h3>
                <p>
                  A hash is a value generated by a hash function. It transforms
                  an input of any length into an output of fixed length. If the
                  input is the same, the output hash value will always be the
                  same. If the input is different, the hash value will almost
                  always be different.
                </p>
                <p>
                  Hash values are irreversible, unique, and easy to verify. In
                  blockchain, each block’s hash value is unique, tamper-proof,
                  and permanent.
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-purple-300">Types of USDT</h3>
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    <strong>Omni-USDT:</strong> Based on Bitcoin platform.
                    Deposit/withdraw via Bitcoin network.
                  </li>
                  <li>
                    <strong>ERC20-USDT:</strong> Based on Ethereum platform.
                    Deposit/withdraw via ETH network.
                  </li>
                  <li>
                    <strong>TRC20-USDT:</strong> Based on TRON network.
                    Deposit/withdraw via TRON network.
                  </li>
                </ul>
                <p className="mt-2">
                  TRX WinGo is based on{" "}
                  <strong>TRC20 protocol and TRON network</strong>. It uses the{" "}
                  <strong>last digit of the block hash</strong> as the result.
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-purple-300">How to Play</h3>
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    1 minute = 1 game. Place bets within the first 55 seconds.
                  </li>
                  <li>No betting allowed in the last 5 seconds.</li>
                  <li>One day has 1440 rounds.</li>
                  <li>Bet of 100 → 2 fee deducted → actual bet = 98.</li>
                  <li>
                    Other modes (3m, 5m, 10m) follow same rules, only result
                    times differ.
                  </li>
                  <li>
                    The last digit of the block hash determines the result.
                  </li>
                </ul>
                <p className="mt-2">
                  <strong>Example:</strong>
                  <br />
                  Hash <code>**b569</code> → Result = 9<br />
                  Hash <code>**d14c</code> → Result = 4
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-purple-300">Payout Rules</h3>
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    <strong>Green:</strong> 1,3,7,9 → 98×2=196 | 5 → 98×1.5=147
                  </li>
                  <li>
                    <strong>Red:</strong> 2,4,6,8 → 98×2=196 | 0 → 98×1.5=147
                  </li>
                  <li>
                    <strong>Purple/Violet:</strong> 0 or 5 → 98×4.5=441
                  </li>
                  <li>
                    <strong>Number Bet:</strong> Exact match → 98×9=882
                  </li>
                  <li>
                    <strong>Big:</strong> 5–9 → 98×2=196
                  </li>
                  <li>
                    <strong>Small:</strong> 0–4 → 98×2=196
                  </li>
                </ul>
              </div>
            </div>
