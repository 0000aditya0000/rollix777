...
const HotGames: React.FC<HotGamesProps> = ({ title, type }) => {
  ...
  // Add this new constant for mobile games limit
  const MOBILE_GAMES_LIMIT = 6;

  // Modify the filtered games for mobile view
  const mobileGames = filteredGames.slice(0, MOBILE_GAMES_LIMIT);
